...
public class XCSearchLetterFragment extends XCBaseFragment {
    ...
    public void setData(XCJsonBean origin_bean) {
        out_jsons = (ArrayList<XCJsonBean>) origin_bean.getList("sections" , new ArrayList<XCJsonBean>());
        // 解析第一层的数据
    ...
    class OutSearchLetterAdapter extends XCBaseAdapter<XCJsonBean> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            // 解析第二层的数据
            ArrayList<XCJsonBean> inner_jsons = (ArrayList<XCJsonBean>) bean.getList("brands", new ArrayList<XCJsonBean>());
