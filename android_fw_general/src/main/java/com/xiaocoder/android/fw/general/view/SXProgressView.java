 ...
 * android:id="@+id/sx_id_progress"
 * android:layout_width="70dp"
 * android:layout_height="70dp"
 * android:layout_centerInParent="true"
 * custom:arc_progress="0"/>
 */
public class SXProgressView extends View {
    private Paint paint;
    ...
    private final int default_finished_color = Color.rgb(254, 201, 85);
    private final int default_unfinished_color = Color.rgb(101, 103, 102);
    private final int default_text_color = Color.rgb(254, 201, 85);
    ...
    public SXProgressView(Context context, AttributeSet attrs) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            canvas.drawText(suffixText, getWidth() / 2.4f + textPaint.measureText(text) + suffixTextPadding, textBaseline, textPaint);
        }
