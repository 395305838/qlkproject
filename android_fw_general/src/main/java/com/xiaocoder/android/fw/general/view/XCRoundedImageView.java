 ...
 *
 ...
 XCRoundedImageView sriv = new XCRoundedImageView(context);
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                XCApplication.printe("SelectableRoundedImageView---Unable to find resource: " + mResource, e);
                // Don't try again.
                mResource = 0;
            }
        }
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
            if (drawable != null) {
                ...
                if (bm != null) {
                    ...
                    XCApplication.printe("SelectableRoundedImageView---Failed to create bitmap from drawable!");
                }
            }
            return drawable;
        }
