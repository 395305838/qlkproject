...
public class XCMaterialListRefreshLayout extends XCRefreshLayout {
    ...
    public XCMaterialListRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public XCMaterialListRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
