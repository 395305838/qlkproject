...
public interface XLIPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(XLPhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(XLPhotoViewAttacher.OnPhotoTapListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(XLPhotoViewAttacher.OnViewTapListener listener);
