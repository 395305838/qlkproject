 ...
 * </p>
 * <p>By default {@link org.eclipse.paho.client.mqttv3.persist.MqttDefaultFilePersistence} is used to store messages to a file.
...
public class MqttClient implements IMqttClient { //), DestinationProvider {
	 ...
	 *
	 * <p>An instance of the default persistence mechanism {@link org.eclipse.paho.client.mqttv3.persist.MqttDefaultFilePersistence}
	 ...
	 * class {@link org.eclipse.paho.client.mqttv3.persist.MqttDefaultFilePersistence} which will work in all Java SE based
