...
public class LoggerFactory {
    ...
    public static Logger getLogger(String messageCatalogName, String loggerID) {
        ...
        logger = getLogger(loggerClassName, createBundle(), loggerID, null);

        /*
         * ecplise中该句话代码有效，但是studio中无效 ，所以就另写了个logger = getLogger(loggerClassName, createBundle(), loggerID, null);
         */
...
//        try {
//
//            XCApplication.base_log.i("XC_MqttService", "here");
//            String str = XCApplication.base_io.getFileFromAssets("logcat.properties");
//            XCApplication.base_log.i("XC_MqttService", str);
//
//            File file = XCApplication.base_io.write2SDCard("mqtt", "logcat.properties", str);
//            XCApplication.base_log.i("XC_MqttService", file.getAbsolutePath());
//
//            String name = file.getAbsolutePath().substring(0, file.getAbsolutePath().lastIndexOf("."));
//
//            XCApplication.base_log.i("XC_MqttService", name);
//
//            ResourceBundle bundle = ResourceBundle.getBundle(name);
//            XCApplication.base_log.i("XC_MqttService", "bundle----" + bundle);
//
//            return bundle;
//        } catch (Exception e) {
//            e.printStackTrace();
//            XCApplication.base_log.i("XC_MqttService", "bundle----excpetion");
//            return null;
//        }
//    }
