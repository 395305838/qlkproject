...
import com.xiaocoder.android.fw.general.view.refreshLayout.XCMaterialGridRefreshLayout;
...
public class GridMaterialActivity extends QlkActivity {
    ...
    public void reqeust() {
        XCApp.getAsyn(false, this, url, new HashMap(), new QlkResponseHandlerModel<TestModel>(this, TestModel.class) {
    ...
    public void listeners() {
        xcGridRefreshLayout.setHandler(new XCRefreshHandler() {
            @Override
