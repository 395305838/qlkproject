package com.xiaocoder.zxcode.view;
 ...
 * 如果要修改扫描框的大小，去CameraManager类里面修改
 */
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawBitmap(((BitmapDrawable) (getResources().getDrawable(R.drawable.xc_d_scan_line))).getBitmap(), null, lineRect, paint);
			...
			canvas.drawText(text, (width - textWidth) / 2, (float) (frame.bottom + (float) TEXT_PADDING_TOP * density) + 100, paint);
